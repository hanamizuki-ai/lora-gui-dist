...
<span class="line"></span></code></pre></div>`,16);function u(F,g){const a=o("ExternalLinkIcon");return e(),c("div",null,[s("div",i,[y,C,E,s("p",null,[n("Author "),s("a",d,[n("\u79CB\u8449 aaaki"),l(a)]),n(" Github "),s("a",h,[n("lora-scripts"),l(a)])])]),A])}var _=p(B,[["render",u],["__file","index.html.vue"]]);export{_ as default};
